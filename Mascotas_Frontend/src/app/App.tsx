...
import NewLostPet from "../pets/LostPets/NewLostPets"
import DetailLostPet from "../pets/LostPets/DetailLostPet"
        ...
        <tbody>
          <tr>
            ...
            <td id="content" className="app_content">
              ...
              <LoggedInRoute path="/editPet/:idPet" component={NewPet} />
              <LoggedInRoute path="/pets/lost_pets" component={LostPets} />
              <LoggedInRoute path="/pet/:idPet/editLost_pet/" component={NewLostPet} />
              <LoggedInRoute path="/pet/editlost_pet/:idLostPet" component={NewLostPet} />
              <LoggedInRoute path="/pet/lostPet/detail/:idLostPet" component={DetailLostPet} />
            </td>
          </tr>
        </tbody>
      </table>
